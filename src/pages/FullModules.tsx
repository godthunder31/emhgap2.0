...
import './FullModules.css'; // Import your CSS file
  ...
  return (
    <IonPage>
      <IonHeader>
        ...
        <IonButton onClick={() => navigate('/index')}>←</IonButton>
      ...
      <IonContent>
        <div className="container">
          ...
          <IonCard className="module" routerLink="/DisordersDueToSubstanceUsePage">

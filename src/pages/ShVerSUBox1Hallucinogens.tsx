...
const ShVerSUBox1Hallucinogens: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'hallucinogens', // or the specific substance
          activeTab,
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Hallucinogens</h2>
        </div>
...
export default ShVerSUBox1Hallucinogens;
...
const AssessStep6Pg2 = () => {
  ...
  const handleProceed = () => {
    ...
    if (meetsCriteria) {
      ...
      navigate('/AssessStep6Pge2Yes', { state: { selectedSymptoms } });
    } else {
      console.log('Criteria not met. Redirecting to AssessStep6Pg1');
      navigate('/AssessStep6Pg3', { state: { selectedSymptoms } });
    }
  };
    ...
    <div className="assess-container">
      <header className={styles['header']}>
        ...
        <div className={styles['breadcrumb']}>
          <span>MNS CONDITIONS</span>
        </div>
        <h2>STEP 6: Assess for Home Environment</h2>
      </header>
      ...
      <div className={styles['scrollable-content']}>
        <main className={styles['content']}>
          ...
          <section className={styles['overview']}>
            <h3>Do the carers have concurrent MNS condition (as per master chart) that could impact their ability to care for the child/adolescent? </h3>
            <p>! IF THERE IS IMMINENT RISK OF SUICIDE, REFER THE CARER TO PSYCHIATRIST. </p>
          </section>

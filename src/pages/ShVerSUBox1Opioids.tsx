...
import styles from './ShVerSUBox1Opioids.module.css';
...
const ShVerSUBox1Opioids: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'Opioids', // or the specific substance
          activeTab,
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Opioids</h2>
        </div>
...
export default ShVerSUBox1Opioids;
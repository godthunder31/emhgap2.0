...
import styles from './ShVerSUBox1VolatileSolvents.module.css';
...
const ShVerSUBox1VolatileSolvents: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'solvents', // or the specific substance
          activeTab,
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Volatile Solvents</h2>
        </div>
...
export default ShVerSUBox1VolatileSolvents;
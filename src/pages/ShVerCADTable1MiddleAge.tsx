...
import styles from './ShVerCADTable1MiddleAge.module.css';
...
const ShVerCADTable1MiddleAge: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'middle', // Specific age group selected
          activeTab,
        }
      });
    } else {
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Middle Childhood (age 6-12)</h2>
        </div>
...
export default ShVerCADTable1MiddleAge;
...
import styles from './ShVerCADTable1Infants.module.css';
...
const ShVerCADTable1Infants: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'infants', // Specific age group selected
          activeTab,
        }
      });
    } else {
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Infants and Young Children (age &lt;5)</h2>
        </div>
...
export default ShVerCADTable1Infants;

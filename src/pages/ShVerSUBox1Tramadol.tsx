...
import styles from './ShVerSUBox1Tramadol.module.css';
...
const ShVerSUBox1Tramadol: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'Tramadol', // or the specific substance
          activeTab,
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Tramadol</h2>
        </div>
...
export default ShVerSUBox1Tramadol;
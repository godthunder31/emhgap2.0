...
const AssessStep2EndYes = () => {
  const navigate = useNavigate();

  const handleProceed = () => {
    navigate('/AssessStep3Pg1'); // Replace with the actual route
  };
    ...
    <div className={styles['container']}>
      ...
      <main className={styles['content']}>
        <div className={styles['arrow-box']}>
          <span className={styles['arrow-text']}>TREAT PHYSICAL CONDITION </span>
        </div>
...
export default AssessStep2EndYes;
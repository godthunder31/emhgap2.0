...
import styles from './ShVerSubstanceUsePage.module.css'; // Import the CSS module
...
const ShVerSubstanceUsePage: React.FC = () => {
  ...
  return (
    ...
    <div className={styles.container}>
        ...
        <IonCard routerLink="/ShVerSUAssessment" className={styles.card}>
        ...
        <IonCard routerLink="/ShVerSUFollowup" className={styles.card}>
...
export default ShVerSubstanceUsePage;

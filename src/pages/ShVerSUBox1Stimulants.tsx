...
import styles from './ShVerSUBox1Stimulants.module.css';
...
const ShVerSUBox1Stimulants: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {  
        state: {
          fromPage: 'Stimulants', // or the specific substance
          activeTab,
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Cocaine, Methamphetamines & Amphetamine-type stimulants</h2>
        </div>
...
export default ShVerSUBox1Stimulants;
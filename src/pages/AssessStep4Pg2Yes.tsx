...
const AssessStep4Pg2Yes = () => {
  const navigate = useNavigate();

  const handleProceed = () => {
    navigate('/AssessStep4Pg3'); // Replace with the actual route
  };
    ...
    <div className={styles['container']}>
      ...
      <main className={styles['content']}>
        <div className={styles['arrow-box']}>
          <span className={styles['arrow-text']}>Consider EMOTIONAL DISORDER </span>
        </div>
...
export default AssessStep4Pg2Yes;
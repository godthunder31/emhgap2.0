...
import styles from './ShVerSUBox1Mdma.module.css';
...
const ShVerSUBox1Mdma: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'Mdma', // or the specific substance
          activeTab,
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Mdma</h2>
        </div>
...
export default ShVerSUBox1Mdma;
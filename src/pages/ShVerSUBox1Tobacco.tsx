...
import styles from './ShVerSUBox1Tobacco.module.css';
...
const ShVerSUBox1Tobacco: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'Tobacco', // or the specific substance
          activeTab,
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Tobacco</h2>
        </div>
...
export default ShVerSUBox1Tobacco;
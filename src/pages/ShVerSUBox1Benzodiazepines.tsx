...
import styles from './ShVerSUBox1Benzodiazepines.module.css';
...
const ShVerSUBox1Bezodiazepines: React.FC = () => {
  ...
  const handleNextClick = () => {
    ...
    if (checkedCount >= 3) {
      ...
      navigate('/ShVerSUFollowup', {
        state: {
          fromPage: 'benzodiazepines', // or the specific substance
          activeTab,
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <div className={styles.titleSection}>
          <h2 className={styles.pageTitle}>Benzodiazepines</h2>
        </div>
...
export default ShVerSUBox1Bezodiazepines;

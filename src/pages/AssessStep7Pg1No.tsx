    ...
    <div className={styles['container']}>
      ...
      <main className={styles['content']}>
        <div className={styles['arrow-box']}>
          <span className={styles['arrow-text']}>Management Summary</span>
        </div>
        <ul className={styles['action-list']}>
          <li>*Provide information on educational services. </li>  
          <li>*Educate carer on importance of keeping child in school  </li>
          <li> </li>
        </ul>
        <button
...
export default AssessStep7Pg1No;